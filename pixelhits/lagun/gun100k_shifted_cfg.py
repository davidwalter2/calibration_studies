...
# --- LA response study: flat true Lorentz angle, +5 percent ---
process.mix.digitizers.pixel.LorentzAngle_DB = cms.bool(False)
process.mix.digitizers.pixel.TanLorentzAnglePerTesla_BPix = cms.double(0.1113)
process.mix.digitizers.pixel.TanLorentzAnglePerTesla_FPix = cms.double(0.1113)
process.FEVTDEBUGoutput.fileName = cms.untracked.string('file:gun_shifted.root')
...
process.FEVTDEBUGoutput.fileName = cms.untracked.string('file:/ceph/submit/data/user/d/david_w/ZMass/cvh/lagun/gun_shifted.root')
...
process.FEVTDEBUGoutput.fileName = cms.untracked.string('file:/ceph/submit/data/user/d/david_w/ZMass/cvh/lagun/gun100k_shifted.root')
