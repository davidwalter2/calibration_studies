#!/bin/bash
# Build msterms_g4driver against the ALREADY-BUILT CMSSW area (pattern copied
...
OUT="$DEST/msterms_g4driver"
"$LOCK" run g++ -O2 -std=c++17 -o "$OUT" "$SRCDIR/msterms_g4driver.cc" \
