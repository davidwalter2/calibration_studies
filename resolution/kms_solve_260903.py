#!/usr/bin/env python3
"""[2026-09-03 variant: Kokoulin-off caches, raw normalisation on the CGF arms]
...
SAMPLES = (
    ("mugun_ul16_260830_raw_k0", "mu pT 20-60  [C: CGF Fisher weight, raw norm]", 0.0563),
    ("mugun_ul16_260830_m0_k0", "mu pT 20-60  [B: legacy truncated Q]", 0.0563),
    ("mugun_lowpt_260830_raw_k0", "mu pT 2-20   [C: CGF Fisher weight, raw norm]", 0.0821),
    ("mugun_lowpt_260830_m0_k0", "mu pT 2-20   [B: legacy truncated Q]", 0.0821),
)
...
OLD = {"mugun_ul16_260830_raw_k0": "runs/cf_trackres_mugun_ul16_fix.npz",
       "mugun_lowpt_260830_raw_k0": "runs/cf_trackres_mugun_lowpt_fix.npz"}
