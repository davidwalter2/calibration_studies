...
step kernel  python3 cf_mass_likelihood.py --kernel   --files "$G/task_*/globalcor_*.root" --ntasks 160 \
     --kernel-cache runs/cf_masskernel_$TAG.npz --postfix "_$TAG"
step pairs   python3 cf_mass_likelihood.py --pairs-tt --files "$G/task_*/globalcor_*.root" --ntasks 160 \
