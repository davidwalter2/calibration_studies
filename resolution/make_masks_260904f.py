#!/usr/bin/env python3
"""Quality masks for the _260904f (clamp-fix) candidate caches.

Same construction as `make_censor_masks_260904.py` family B/quality, applied to
whichever of the two productions is present, so the WITH-clamp (_260903x) and
WITHOUT-clamp (_260904f) fits use identical selections.

usage: python3 make_masks_260904f.py [tag ...]   (default: both)
"""
import os
import sys
...
OUT = "runs/clampfix260904"
SIGMAX = 0.15
CACHES = {
    "gun_260904f": ("runs/cf_masspairs_jpsigun_ul16_260904f_m0.npz",
                    f"{OUT}/aux_jpsigun_260904f.npz"),
    "v3_260904f": ("runs/cf_masspairs_btojpsix_v3_260904f_m0.npz",
                   f"{OUT}/aux_btojpsix_260904f.npz"),
}
