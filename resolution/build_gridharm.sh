...
DEST=${1:-/tmp/claude-125124/-work-submit-david-w-ZMass/004b7dc0-60d9-4f5d-880a-237d4d3c5e98/scratchpad}
...
OUT="$DEST/gridharm_g4driver"
"$LOCK" run g++ -O2 -std=c++17 -o "$OUT" "$SRCDIR/gridharm_g4driver.cc" \
