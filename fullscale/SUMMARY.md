...
| **`K(m)` 9** | **+9.39 +- 2.31** | **NOT ATTAINABLE** — 65 Hessians, no density NaN, indefinite Hessian at the end point (5.3) |
...
floor at 1e-7, ran 65 Hessian evaluations in 2 h 26 with NO density NaN — the
